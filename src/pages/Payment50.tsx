    ...
    <div className="min-h-screen bg-dark-roast pt-32 pb-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-white mb-4">Book with 50% Advance</h1>
          <p className="text-gray-400 max-w-2xl mx-auto font-light">
            Secure your table by paying half now and the rest at the restaurant.
          </p>
        </div>

        <PaymentForm paymentMethod="advance" title="Pay 50% & Confirm Table" />
      </div>
    </div>
  );
}
